  ...
  <section class="navbar">
    <div class="navwrapper">
      <div id="nav">
        ...
        <div class="logoSect">
          <router-link to="/" :getPosts="getPosts">YouTube</router-link>
        </div>
  
        <div class="linkBar">
          <div>
            <router-link to="/" :getPosts="getPosts">POST</router-link>
          </div>
          <div>
...
<script lang="js">
  ...
  export default {
    name: 'navbar',
    props: ['setUser', 'setMessage', 'user', 'posts', 'getPosts', 'setFilteredPosts'],
    components: {
    ...
    methods: {
      getSearch(){
        this.$router.push('/')
        let self = this
        console.log(self.model.searchinput);
        axios.get(`https://www.googleapis.com/youtube/v3/search?p=${self.model.searchinput}&key=AIzaSyDRi-6TD8hd6DaVWwp6N5R3pMv4LUVi-9o&part=snippet,id&order=date&maxResults=8`)
          .then((result) => {
